...
/>`,
	props: [
		...
		},
		{
			...
			default: '"short"',
			description:
				"Row shape for the large footprint. `short` leads with a 32px identity and an agent · host · time byline. `long` drops the leading avatar, gives the title the full width, and adds agent, a cycling tool call, an artifact chip, session type/time, and a trailing indicator. Ignored by the medium and small footprints, which have fixed geometry.",
		},
		{
			name: "items",
